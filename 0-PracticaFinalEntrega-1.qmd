...
barrios_28012_1 <- unique(airbnb$Barrio[which(airbnb$CodigoPostal == 28012)])
print(barrios_28012_1)

barrios_28012_2 <- airbnb |> filter(CodigoPostal == 28012)
barrios_28012_2_unicos <- unique(barrios_28012_2$Barrio)
print(barrios_28012_2_unicos)
